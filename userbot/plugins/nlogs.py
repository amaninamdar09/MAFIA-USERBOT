...
@borg.on(admin_cmd(pattern="nlogs ?(.*)"))
async def coder_print(event):
	...
	await event.client.send_file(event.chat_id, "out.png", force_document=True, reply_to=event.reply_to_msg_id, caption="ᴏᴜᴛᴘᴜᴛ ʙʏ [𝙿𝙰𝙽𝚃𝙷𝙴𝚁𝚂 𝙱𝙾𝚃](t.me/BLACKPANTHERSBOLTE)")	
	await res.delete()
	await event.delete()
	os.remove(a)
	os.remove('out.png')
